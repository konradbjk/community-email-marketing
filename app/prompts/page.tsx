...
const mockPrompts = [
  {
    ...
    description:
      'What does the distribution of customers across economic segments reveal about the effectiveness and actionability of our current economic segmentation strategy?',
    content:
      'What does the distribution of customers across economic segments reveal about the effectiveness and actionability of our current economic segmentation strategy?',
  ...
  },
  {
    ...
    description:
      'Which types of emails (e.g., Commercial, Medical, Promotional, Event-related) generate the highest open rates?',
    content:
      'Which types of emails (e.g., Commercial, Medical, Promotional, Event-related) generate the highest open rates?',
  ...
  },
  {
    ...
    description:
      'For a selected brand and Business Unit (BU), how does the proportion of field-team-driven interactions compare to the regional average?',
    content:
      'For a selected brand and Business Unit (BU), how does the proportion of field-team-driven interactions compare to the regional average?',
    category: 'Channel Analytics',
    type: 'final',
  ...
  },
  {
    ...
    description:
      'What are the differences in channel mix for each franchise in Country X, and how do these compare to the regional and global averages?',
    content:
      'What are the differences in channel mix for each franchise in Country X, and how do these compare to the regional and global averages?',
    category: 'Channel Analytics',
    type: 'final',
  ...
  },
  {
    ...
    description:
      'What is the degree of trade-off between face-to-face interactions and all other interaction types over the last X months?',
    content:
      'What is the degree of trade-off between face-to-face interactions and all other interaction types over the last X months?',
    category: 'Channel Analytics',
    type: 'suggestion',
  ...
  },
  {
    ...
    description:
      'Which countries demonstrate the best performance in executing channel X, and how does this compare to the performance in my country?',
    content:
      'Which countries demonstrate the best performance in executing channel X, and how does this compare to the performance in my country?',
    category: 'Channel Analytics',
    type: 'suggestion',
  ...
  },
  {
    ...
    description:
      'How does our omnichannel mix compare to that of other countries in Region X?',
    content:
      'How does our omnichannel mix compare to that of other countries in Region X?',
    category: 'Channel Analytics',
    type: 'suggestion',
  ...
  },
  {
    ...
    description:
      'What type of e-mails/Content maximize open rate (Commercial / Medical, promo, event etc.…) at national level/ in other country?',
    content:
      'What type of e-mails/Content maximize open rate (Commercial / Medical, promo, event etc.…) at national level/ in other country?',
    category: 'Email Marketing',
    type: 'suggestion',
...
export default function PromptsPage() {
  ...
  const recentPrompts = [...filteredPrompts].sort(
            ...
            <div className='flex flex-row justify-between'>
              <div className='space-y-2'>
                ...
                <p className='text-muted-foreground'>
                  Discover and use curated prompts for pharmaceutical research
                  and analysis
                </p>
              </div>
