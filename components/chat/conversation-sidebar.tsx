...
import { Plus, MessageSquare, FolderOpen, User, Settings, BookOpen, Archive, Eye, EyeOff, ArrowLeft } from "lucide-react"
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild>
                  <div className="cursor-pointer">
                    ...
                    <span className="group-data-[collapsible=icon]:sr-only">Chats</span>
                  </div>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                ...
                >
                  <div className="cursor-pointer">
                    ...
                    <span className="group-data-[collapsible=icon]:sr-only">Projects</span>
                  </div>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                ...
                >
                  <div className="cursor-pointer">
                    ...
                    <span className="group-data-[collapsible=icon]:sr-only">Prompts</span>
                  </div>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
